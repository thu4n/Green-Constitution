	...
	public class CollectionImporter {
		...
		public async Task<ImportedCards> Import() {
			...
			foreach (ProtoSpecialCard protoSpecialCard in collection.specialCards) {
				...
				if (protoSpecialCard.id == "gameover_hp"
						|| protoSpecialCard.id == "gameover_eco"
						|| protoSpecialCard.id == "gameover_pl"
						|| protoSpecialCard.id == "gameover_war"
						|| protoSpecialCard.id == "gameover_ecoded"
						|| protoSpecialCard.id == "gameover_win"
						|| protoSpecialCard.id == "gameover_rsc") {
